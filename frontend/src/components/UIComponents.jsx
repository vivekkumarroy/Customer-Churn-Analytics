...
export const MetricCard = ({ title, value, subtitle, icon: Icon, className = '' }) => (
  <div className={`dashboard-card p-4 sm:p-5 flex flex-col justify-between min-h-[140px] sm:min-h-[160px] group relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${className}`}>
